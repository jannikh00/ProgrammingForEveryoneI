...
# list that contains question lists for the loop in the main program
question_container = [question1, question2, question3, question4, question5, question6, question7, question8, question9, question10]
...
while True:
    ...
    for i in range (1,4):
        while True:
            ...
            if n in n_check:
                point_counter, question_counter = question(question_container[n], question_counter, point_counter)
                n_check.append(n)
